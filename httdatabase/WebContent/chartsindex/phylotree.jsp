...
if (idlevel == 2){
	nmfile = realContextPath + "/xml/htt/kingdomtree.xml";
	idlevelgroup = 0;
}
if (idlevel == 3){
	nmfile = realContextPath + "/xml/htt/phylotree.xml";
	idlevelgroup = 1;
}
if (idlevel == 4){
	nmfile = realContextPath + "/xml/htt/classtree.xml";
	idlevelgroup = 2;
}
if (idlevel == 5){
	nmfile = realContextPath + "/xml/htt/ordertree.xml";
	idlevelgroup = 2;
}
if (idlevel == 6){
	nmfile = realContextPath + "/xml/htt/familytree.xml";
	idlevelgroup = 2;
}
if (idlevel == 7){
	nmfile = realContextPath + "/xml/htt/genustree.xml";
	idlevelgroup = 2;
}
...
for (int i = 0; i < nodes.getLength(); i++) {
	...
	uri = request.getContextPath()+ "/resultado/resultado.jsp?organism=1|" + Integer.toString(idlevel) + "|" +  organism + "|" +  organism;
	...
	desc.setTextContent("Number of HTT events: " + qtevents);
