...
<script>
		...
		function loadphylotree(level){
			...
			//Arvore de filogenia
			$.get("./chartsindex/phylotree.jsp?id_level=" + level, function(data) {
				var dataObject = {
					phyloxml: data,
					fileSource: false
				};		
...
<h3 id="phylotree" class="titulo-borda-janela borda-janela" style="width: 100%; ">HTT - Host Cladogram following NCBI taxonomy</h3>
<div class="borda-janela" style="padding-top: 8px; padding-bottom: 8px; width: 100%;text-align: center;" >
	...
	<td>
		<br>
		&emsp;&emsp;
		Holding the cursor over the taxa shows you a hint with the number of HTTs for each taxa. Clicking
		on them will redirect you to the database search with the corresponding HTTs cases. Clicking on the 
		different taxa levels below will reload the cladogram with the correspondent taxa with HTT cases.
		<br>
	</td>
	</tr>
	<tr>
