...
<br>
 ...
 <fieldset>
  <legend style="font-weight: bold;">HVT Table Data (Download model <a href="modeltable_hvt.xls" target="_blank">here</a>)</legend>
...
<br>
 ...
 <fieldset>
  <legend style="font-weight: bold;">Virus Fields: </legend>

		<label style="width: auto;">* Virus Group: (Ex.: I, II, III)</label>
		<br>
		<input type=text id="ds_virus_group" name="ds_virus_group" style="width: 450px;">
		<br>			
			
		<label style="width: auto;">* Virus Type: (Ex.: +ssRNA, -ssRNA, dsDNA)</label>
		<br>
		<input type=text id="ds_virus_type" name="ds_virus_type" style="width: 450px;">
		<br>			

		<label style="width: auto;">* Virus Taxonomic Classification: (Ex.: Mononegavirales;Nyamiviridae;Nyavirus)</label>
		<br>
		<input type=text id="ds_virus" name="ds_virus" style="width: 450px;">
		<br>			
</fieldset>
 ...
 <fieldset>
  <legend style="font-weight: bold;">Host Organism Fields: (According to NCBI Taxonomy - <a  href="http://www.ncbi.nlm.nih.gov/taxonomy" target="_blank">link</a>)</legend>
		...
		<label style="width: auto;">HVT Dating Estimates (Million Years): (Ex.: '0-3.1', '120', '300-400')</label>
		<br>
		<input type=text id="dt_estimated_hvt" name="dt_estimated_hvt" style="width: 450px;">
		<br>			
